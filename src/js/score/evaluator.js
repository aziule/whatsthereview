function Evaluator(doubleMetaphone) {
...
Evaluator.prototype.evaluateMatchingScore = function(needle, movies) {
    var matching = [];
...
Evaluator.prototype.getDoubleMetaphoneMatchingPct = function(a, b) {
